...
public class DashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        android.util.Log.d("DEBUG_ROLE", "DashboardActivity onCreate: currentRole = " + currentRole);
    ...
    private void showOptionsMenu(View anchor) {
        ...
        android.util.Log.d("DEBUG_ROLE", "showOptionsMenu: currentRole = " + currentRole);
        ...
        // Hide tables and categories for manager (only show for Admin)
        boolean isAdmin = Constants.ROLE_ADMIN.equals(currentRole);
        sheet.findViewById(R.id.row_tables).setVisibility(isAdmin ? View.VISIBLE : View.GONE);
        sheet.findViewById(R.id.row_categories).setVisibility(isAdmin ? View.VISIBLE : View.GONE);
        ...
        // Hide shift template for manager (only show for Admin)
        sheet.findViewById(R.id.row_shift_template).setVisibility(isAdmin ? View.VISIBLE : View.GONE);
        ...
        // Hide staff personal rows for Admin and Manager (only show for Staff)
        boolean isStaff = Constants.ROLE_STAFF.equals(currentRole);
        sheet.findViewById(R.id.row_my_shift).setVisibility(isStaff ? View.VISIBLE : View.GONE);
        sheet.findViewById(R.id.row_my_availability).setVisibility(isStaff ? View.VISIBLE : View.GONE);
        sheet.findViewById(R.id.row_leave_request).setVisibility(isStaff ? View.VISIBLE : View.GONE);
