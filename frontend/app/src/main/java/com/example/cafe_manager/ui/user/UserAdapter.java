...
public class UserAdapter extends ListAdapter<UserEntity, UserAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(UserEntity user) {
            ...
            String myRole = com.example.cafe_manager.manager.SessionManager.getInstance(itemView.getContext()).getRole();
            if (Constants.ROLE_MANAGER.equals(myRole)) {
                btnEdit.setVisibility(View.GONE);
                btnToggleActive.setVisibility(View.GONE);
                itemView.setOnLongClickListener(null);
            } else {
                btnEdit.setVisibility(View.VISIBLE);
                btnToggleActive.setVisibility(View.VISIBLE);
