...
public class LeaveApprovalAdapter extends RecyclerView.Adapter<LeaveApprovalAdapter.ViewHolder> {
    ...
    public interface OnLeaveApprovalActionListener {
        void onApprove(LeaveRequestResponse request);
        void onReject(LeaveRequestResponse request);
    }

    private List<LeaveRequestResponse> items = new ArrayList<>();
    private final OnLeaveApprovalActionListener listener;
    private final SimpleDateFormat dateTimeFormat = new SimpleDateFormat("dd/MM/yyyy HH:mm", Locale.getDefault());

    public LeaveApprovalAdapter(OnLeaveApprovalActionListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvStaffName.setText(item.getUserName() != null ? item.getUserName() : "Nhân viên");
        ...
        // Affected assignment count check
        if (item.getAffectedAssignmentCount() != null) {
            holder.tvAffectedCount.setText("Số ca trùng bị hủy: " + item.getAffectedAssignmentCount());
            holder.tvAffectedCount.setVisibility(View.VISIBLE);
        } else {
            holder.tvAffectedCount.setVisibility(View.GONE);
        }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        public TextView tvStaffName, tvCreatedAt, tvStatusBadge, tvTimeRange, tvReason, tvAffectedCount, tvReviewNote, tvReviewedAt;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            tvAffectedCount = itemView.findViewById(R.id.tvAffectedCount);
